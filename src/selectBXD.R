...
d <- read.csv(file="/Users/xiaoqihu/Documents/hg/lm-gpu/data/hippocampus/GN283_MeanDataAnnotated_rev081815.txt",skip=32,
              sep="\t",colClasses="character")
## read genotype file as character
g <- read.csv("../../geno/BXD_current.geno",sep="\t",skip=21,
...
## write out file
write_csv(gd,path="geno-pheno.csv",col_names=F,na="")
...
write_csv(gd,path="geno-pheno-rqtl.csv",col_names=F,na="")

## read in data in R/qtl
bxd <- read.cross(file="geno-pheno-rqtl.csv",format="csv",
